...
async def on_startup(bot) -> None:
    ...
    try:
        ...
        commands_list = [
            ...
            BotCommand(command="crypto", description="🪙 Cryptocurrency Market"),
            BotCommand(command="stocks", description="📈 Stock Market"),
            BotCommand(command="portfolio", description="💼 Investment Portfolio"),
            BotCommand(command="alert", description="🔔 Price Alerts"),
            BotCommand(command="donate", description="☕️ Support the project"),
            BotCommand(command="settings", description="⚙️ Language and Currency Settings"),
            BotCommand(command="privacy", description="🔐 Privacy Policy"),
            BotCommand(command="help", description="ℹ️ This help message"),
        ]
