...
def crypto_keypad(amount: float) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text="£", callback_data=f"crypto GBP {amount}"),
            InlineKeyboardButton(text="€", callback_data=f"crypto EUR {amount}"),
            InlineKeyboardButton(text="₴", callback_data=f"crypto UAH {amount}"),
        ],
        [
            InlineKeyboardButton(text="zł", callback_data=f"crypto PLN {amount}"),
            InlineKeyboardButton(text="Kč", callback_data=f"crypto CZK {amount}"),
        ],
    ])
...
def settings_menu(i18n: I18n, lang: str) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text=s.get("bot", "🤖 Bot"), callback_data="bot"),
...
def bot_settings_kb(i18n: I18n, lang: str) -> InlineKeyboardMarkup:
    s = i18n.get_section("keyboard.settings", lang)
    return InlineKeyboardMarkup(inline_keyboard=[
        [
        ...
        [InlineKeyboardButton(text=s.get("back", "◀️ Back"), callback_data="menu")],
    ])
